...
setwd("~/Herrera_Michael_Assignment03/DSC520")

## Load the 'data/r4ds/heights.csv' to
heights_df <- read_excel("C:/Users/714Mi/Desktop/DSC520/heights.xlsx")
...
## Create a histogram of the 'earn' variables using 'geom_histogram()'
